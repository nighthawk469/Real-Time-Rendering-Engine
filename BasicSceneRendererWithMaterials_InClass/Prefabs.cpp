...
Mesh* CreateWireframeBox(float width, float height, float depth)
{
    ...
    // sides
    vertices.push_back(VertexPC(-w, -h, -d, 0, 1.0f, 0, 1.0f));
    vertices.push_back(VertexPC(-w,  h, -d, 0, 1.0f, 0, 1.0f));
    vertices.push_back(VertexPC(-w, -h,  d, 0, 1.0f, 0, 1.0f));
    vertices.push_back(VertexPC(-w,  h,  d, 0, 1.0f, 0, 1.0f));
    vertices.push_back(VertexPC( w, -h, -d, 0, 1.0f, 0, 1.0f));
...
Mesh* CreateWireframeBox2(float width, float height, float depth)
{
	std::vector<VertexPC> vertices;
	...
	// sides
	vertices.push_back(VertexPC(-w, -h, -d, 1.0, 0, 0, 1.0f));
	vertices.push_back(VertexPC(-w, h, -d, 1.0, 0, 0, 1.0f));
	vertices.push_back(VertexPC(-w, -h, d, 1.0, 0, 0, 1.0f));
	vertices.push_back(VertexPC(-w, h, d, 1.0, 0, 0, 1.0f));
	vertices.push_back(VertexPC(w, -h, -d, 1.0, 0, 0, 1.0f));
...
Mesh* CreateLine(glm::vec3 start, glm::vec3 end)
{
	std::vector<VertexPC> vertices;

	vertices.push_back(VertexPC(start[0], start[1], start[2], 1, 0, 0, 1));
	vertices.push_back(VertexPC(end[0], end[1], end[2], 1, 0, 0, 1));
